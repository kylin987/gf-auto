...
from utils.goofish_utils import generate_sign, trans_cookies, generate_device_id, get_node_bin
from utils.sign import generate_mtop_sign
...
class XianyuApis:
    def __init__(self, cookies, device_id, user_agent=UA):
    ...
    def get_token(self, retried=False):
        headers = {
            ...
            "sec-ch-ua-platform": _chrome_platform(self.user_agent),
            "user-agent": self.user_agent,
            "accept": "application/json",
            "sec-ch-ua": _chrome_sec_ch_ua(self.user_agent),
            "content-type": "application/x-www-form-urlencoded",
            "sec-ch-ua-mobile": "?0",
            "origin": "https://www.goofish.com",
            "sec-fetch-site": "same-site",
    ...
    def get_order_detail(self, order_id):
        ...
        data_val = json.dumps({
            ...
            'orderIds': '',
            'queryCode': 'ALL',
            'orderSearchParam': json.dumps({'preciseQuery': str(order_id)}, ensure_ascii=False, separators=(',', ':')),
        }, separators=(',', ':'))
        return self._seller_mtop_post(
